...
public class Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "/userEdit-process.do":
			...
			user.setU_tel(request.getParameter("u_tel1") + "-" + request.getParameter("u_tel2") + "-"
...
//				board = (Board)session.getAttribute("board");
	...
	String checkSession(HttpServletRequest request, HttpServletResponse response, String command) {
		...
		String[] authList = { "/logininsert.do", "/insert-process.do", "/userdetail.do", "/userEdit.do",
				"/userEdit-process.do", "/logout.do" };
